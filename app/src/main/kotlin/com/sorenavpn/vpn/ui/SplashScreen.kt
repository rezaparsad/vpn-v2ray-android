...
import com.sorenavpn.vpn.network.RequestResponseCallback
import com.sorenavpn.vpn.network.Requests
import com.sorenavpn.vpn.util.AngConfigManager
import com.sorenavpn.vpn.util.CheckInternet
...
class SplashScreen : AppCompatActivity() {
    ...
    private fun getData() {
        Requests(this).post("http://sorena.vpnload.de/api/v1/status/", object: RequestResponseCallback {
