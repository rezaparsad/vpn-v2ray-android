...
import com.vpnload.vpn.AppConfig.ANG_CONFIG
import com.vpnload.vpn.AppConfig.HTTPS_PROTOCOL
import com.vpnload.vpn.AppConfig.HTTP_PROTOCOL
import com.vpnload.vpn.R
import com.vpnload.vpn.dto.*
import com.vpnload.vpn.dto.V2rayConfig.Companion.DEFAULT_SECURITY
import com.vpnload.vpn.dto.V2rayConfig.Companion.TLS
import com.vpnload.vpn.util.MmkvManager.KEY_SELECTED_SERVER
import java.net.URI
import java.util.*
import com.vpnload.vpn.extension.idnHost

object AngConfigManager {
    val mainStorage by lazy {
        MMKV.mmkvWithID(
            MmkvManager.ID_MAIN,
