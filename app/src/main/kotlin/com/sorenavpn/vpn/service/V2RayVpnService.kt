...
import com.sorenavpn.vpn.dto.ERoutingMode
...
class V2RayVpnService : VpnService(), ServiceControl {
    ...
    private var timerConnector: Subscription? = null
    ...
    override fun onCreate() {
        ...
        val ttl = settingsStorage.decodeString(AppConfig.TIME_STOP_CONNECTED, "3600000")?.toLong() ?: 1000
        timerConnector = Observable.timer(ttl, TimeUnit.MILLISECONDS)
