package com.sorenavpn.vpn.service
...
import com.sorenavpn.vpn.AppConfig.TAG_DIRECT
import com.sorenavpn.vpn.R
import com.sorenavpn.vpn.dto.ServerConfig
import com.sorenavpn.vpn.extension.toSpeedString
import com.sorenavpn.vpn.ui.MainActivity
import com.sorenavpn.vpn.util.MessageUtil
import com.sorenavpn.vpn.util.MmkvManager
import com.sorenavpn.vpn.util.Utils
import com.sorenavpn.vpn.util.V2rayConfigUtil
import go.Seq
...
//                    startSpeedNotification()
    ...
    private fun createNotificationActionButton(text: String): NotificationCompat.Action {
        ...
        return NotificationCompat.Action(R.drawable.ic_close_grey_800_24dp, text, pendingIntent)
    }
    private fun showNotification() {
        ...
        mBuilder = NotificationCompat.Builder(service, channelId)
            ...
            .addAction(createNotificationActionButton("Stop"))
